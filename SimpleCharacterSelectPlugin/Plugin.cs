...
namespace SimpleCharacterSelectPlugin
{
    public sealed class Plugin : IDalamudPlugin
    {
        ...
        // Shared Name Manager for other SCS users' names
        ...
        public unsafe Plugin(IGameInteropProvider gameInteropProvider)
        {
            ...
            commands = new Commands(this, CommandManager, ChatGui);
        ...
        private void HandleSaveCommand(string args)
        {
            ...
            // Find currently applied SCS character 
        ...
        public void SetActiveCharacter(Character character)
        {
            ...
            if (ObjectTable.LocalPlayer is { } player && player.HomeWorld.IsValid)
            {
                ...
                string pluginCharacterKey = $"{character.Name}@{worldName}"; // SCS character identity
