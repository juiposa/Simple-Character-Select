...
namespace SimpleCharacterSelectPlugin
{
    ...
    {   
        ...
        // {
        //     return plugin.ActivePlayer.Pc.ActiveCharacter?.Data.Name ?? "";
        // }
        //
        // /// <summary>
        ...
        //     Plugin.Log.Info($"[IPC] Active character: {plugin.ActivePlayer.Pc.ActiveCharacter?.Data.Name ?? "None"}");
        //     
        //     foreach (var character in plugin.Characters)
        //     {
        //         bool isActive = plugin.ActivePlayer.Pc.ActiveCharacter?.Data.Name == character.Data.Name;
